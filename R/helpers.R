...
.get_opt <- function(mode) {
  switch(mode,
    "dag-dc" = dag_optim,
    "dg-dc" = dag_optim,
    "admg" = admg_cubic_optim,
    "dmg" = admg_cubic_optim,
    "admg-dc" = admg_optim,
    "dmg-dc" = admg_optim,
    ...
    "dag" = dcon_lean_optim,
    "dg" = dcon_lean_optim,
    "admg-lean" = admg_lean_optim,
    "dmg-lean" = admg_lean_optim
  )
}
